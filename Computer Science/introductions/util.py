...
def scramble(s):
    # start with an initcially emty string
    o = ""
    ...
    while len(s) != 0:
        ...
        # add character from idex to new string
        o = o + s[idx]

        # remove all the characters from s
        # get all characters from before index
        # combine with all characters from after index
        s = s[:idx] + s[idx +1:]
    return o